...
const participantTypes = [
  { id: 'single', title: 'Jugadores' },
  { id: 'team', title: 'Equipos' },
]
          ...
          <div className='mt-5 space-y-6 md:col-span-4 md:mt-0'>
            ...
            <div>
              <div className='flex items-center justify-between'>
                <h2 className='text-sm'>Platforma(s)</h2>
              </div>

              <fieldset aria-required className='mt-2'>
                <label className='sr-only'>Elije almenos una plataforma</label>
