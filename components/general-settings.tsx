                            ...
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent className="lg:ml-12">
                                  <p className="w-80">
                                    This cannot be changed within a tournament.
                                    If you want to change the discipline, create
                                    a new tournament.
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                    ...
                    <div className="mt-4 xl:-mt-2 xl:pl-6 space-y-4">
                      ...
                      <div className="">
                        ...
                        <input
                          ...
                          onChange={(e) => setScheduledDateEnd(e.target.value)}
                          className="block w-full rounded border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-neutral-600 sm:text-sm sm:leading-6"
                        />
                      </div>
                      {dateError && (
                          ...
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent className="lg:ml-12 xl:m-0">
                                <p className="w-80">
                                  Select the timezone you want to use for all
                                  dates and times in the tournament.
                                </p>
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                            ...
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p className="w-80">
                                  ...
                                  , so it doesn&apos;t become invalid during the
                                  tournament.
                                </p>
                              </TooltipContent>
                            </Tooltip>
